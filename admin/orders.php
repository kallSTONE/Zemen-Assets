...
<section style="padding: 2rem 0; background: var(--bg-primary);">
    <div class="container content-center">
        <h1>All Inquiries</h1>
        <p style="color: var(--text-secondary);">Browse Orders</p>
    </div>
</section>
...
<section style="padding: 2rem 0;">
    ...
    <?php else: ?>
        <div class="text-center" style="padding: 4rem 0; background: var(--bg-primary); border-radius: var(--radius-lg);">
            ...
            <h3>No Orders yet</h3>
            <p style="color: var(--text-secondary); margin-bottom: 2rem;">You can add your property listing.</p>
